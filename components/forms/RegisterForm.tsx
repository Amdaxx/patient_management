  ...
  return (
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-1">
      ...
      <CustomFormField 
        ...
        renderSKeleton={(field) => (
            <FormControl>
              <RadioGroup 
                className="flex h-11 gap-6 xl:jusitfy-between"
      ...
      <CustomFormField 
        ...
        placeholder="Penauts, Penicilline, Pollen"
      />
      <CustomFormField 
        fieldType={FormFieldType.TEXTAREA}
        control={form.control}
        ...
        placeholder="Ibuprofen, Amoxilin"
      />
      </div>
      <div className="flex flex-col gap-6 xl:flex-row">
      <CustomFormField 
    ...
    <CustomFormField 
      ...
      <CustomFormField 
        ...
        label="I consent to discolusere of information"
      />
